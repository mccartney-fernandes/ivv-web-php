    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-8">
        <div class="card-body card-posts-text">        
          ...
          <p class="card-text card-post-text-a"><small class="text-muted">Published <?php echo get_the_date(); ?> in by <?php the_author_posts_link(); ?></small></p>
          <p class="card-text"><?php the_excerpt(); ?></p>
          <a href="<?php the_permalink(); ?>" class="badge badge-pill badge-secondary">Continue Lendo ...</a>
